...
describe('Test index', () => {
  it('getParamsForMint', async () => {
    ...
    // or
    // SAI = await IERC20.at("0x89d24a6b4ccb1b6faa2625fe562bdd9a23260359")
    // await SAI.approve("", web3.utils.toBN("1000000000000000000000000000"), {from: "0x83Deb18dC5574dF9558ABF719b7e109fe050560e", gasPrice: web3.utils.toBN("1000000000")})
